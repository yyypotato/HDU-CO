...
HD_PWD='D:/FPGA/CPU_RIUS/CPU_RIUS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_RIUS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_RIUS.tcl
