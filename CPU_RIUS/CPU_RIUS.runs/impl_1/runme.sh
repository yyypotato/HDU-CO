...
HD_PWD='D:/FPGA/CPU_RIUS/CPU_RIUS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_RIUS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU_RIUS.tcl -notrace
