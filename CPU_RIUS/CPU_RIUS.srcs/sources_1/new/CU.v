module CU(rst_n,clk,opcode,funct7,funct3,PC_Write,IR_Write,Reg_Write,rs2_imm_s,OP,w_data_s,Mem_Write);
input rst_n,clk;
input [6:0] opcode,funct7;
input [2:0] funct3;
output reg PC_Write,IR_Write,Reg_Write,rs2_imm_s,Mem_Write;
