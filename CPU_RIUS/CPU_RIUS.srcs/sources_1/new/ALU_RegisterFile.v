module ALU_RegisterFile(imm32,MDR,ALU_OP,clk_RR,Reg_Write,rs2_imm_s,w_data_s,R_Addr_A,R_Addr_B,W_Addr,Reset,clk_WB,FR,Data_A,Data_B,clk_F,F,W_Data);
input [3:0] ALU_OP;
input [31:0] imm32,MDR;
input [1:0] w_data_s;
