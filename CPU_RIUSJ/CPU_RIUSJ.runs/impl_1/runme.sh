...
HD_PWD='D:/FPGA/CPU_RIUSJ/CPU_RIUSJ.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_RIUSJB.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU_RIUSJB.tcl -notrace
