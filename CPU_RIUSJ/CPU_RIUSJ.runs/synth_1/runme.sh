...
HD_PWD='D:/FPGA/CPU_RIUSJ/CPU_RIUSJ.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_RIUSJB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_RIUSJB.tcl
