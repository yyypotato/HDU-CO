...
HD_PWD='D:/FPGA/CPU_RIUCode/CPU_RIUCode.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_RIUCode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU_RIUCode.tcl -notrace
