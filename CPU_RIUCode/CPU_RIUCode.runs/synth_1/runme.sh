...
HD_PWD='D:/FPGA/CPU_RIUCode/CPU_RIUCode.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_RIUCode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_RIUCode.tcl
