module ALU_RegisterFile(imm32,ALU_OP,clk_RR,Reg_Write,rs2_imm_s,w_data_s,R_Addr_A,R_Addr_B,W_Addr,Reset,clk_WB,FR,Data_A,Data_B,clk_F,F,W_Data);
input [3:0] ALU_OP;
input [31:0] imm32;
input clk_RR,Reg_Write,clk_WB,Reset,rs2_imm_s,w_data_s,clk_F;
