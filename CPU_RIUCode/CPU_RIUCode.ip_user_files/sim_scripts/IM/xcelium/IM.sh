...
#
# Script generated by Vivado on Sat May 17 21:47:17 +0800 2025
...
#
# Usage        : IM.sh
#                IM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                IM.sh [-reset_run]
#                IM.sh [-reset_log]
#                IM.sh [-help]
#
...
#                script (type 'IM.sh -help' for more information).
#
...
# script info
echo -e "IM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./IM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.IM xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.IM -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log IM_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: IM.sh [-reset_log]\n\
Usage: IM.sh [-keep_index]\n\
