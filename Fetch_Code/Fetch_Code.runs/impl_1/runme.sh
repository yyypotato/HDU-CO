...
HD_PWD='D:/FPGA/Fetch_Code/Fetch_Code.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Fetch_Code.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Fetch_Code.tcl -notrace
