...
HD_PWD='D:/FPGA/Fetch_Code/Fetch_Code.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fetch_Code.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fetch_Code.tcl
