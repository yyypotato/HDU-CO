...
HD_PWD='D:/FPGA/register_new/register_new.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_RegisterFile.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_RegisterFile.tcl
