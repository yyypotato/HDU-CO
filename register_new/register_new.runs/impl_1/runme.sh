...
HD_PWD='D:/FPGA/register_new/register_new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_RegisterFile.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_RegisterFile.tcl -notrace
